                ...
                .onSnapshot(function(snap) {
                    ...
                    snap.docChanges().forEach(function(change) {
                        ...
                        /* 'added'    — document first seen (includes approved docs on reload)
                           'modified' — admin called .update({status:'approved'}) on an existing
                                        pending doc; Firestore fires 'modified', NOT 'added'.
                                        We must handle both to ensure the card appears immediately. */
                        ...
                        /* Un-publish if admin sets status back to held/rejected */
